...
<head>
    ...
    <title><fmt:message key="product.title" /> - <fmt:message key="app.title" /></title>
...
<body class="bg-light">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="products"><fmt:message key="nav.products" /></a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-4">
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="btn-group">
                    <a href="products" class="btn ${empty selectedCategory ? 'btn-primary' : 'btn-outline-primary'}">
                        All
                    </a>
                    <c:forEach items="${categories}" var="category">
                        <a href="products?category=${category}" 
                           class="btn ${category eq selectedCategory ? 'btn-primary' : 'btn-outline-primary'}">
                            ${category}
                        </a>
                    </c:forEach>
                </div>
